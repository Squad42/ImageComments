...
from imageComments.models import db
from imageComments.example_data import db_load_example_data
import consul
from prometheus_flask_exporter import PrometheusMetrics

app = Flask(__name__)
app.config.from_object("imageComments.server_config.DevelopmentConfig")
...
from imageComments.server_views import *
